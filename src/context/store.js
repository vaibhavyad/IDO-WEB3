...
export const StoreContextProvider = ({ children }) => {
  ...
  const[validDiscord,setvalidIDiscord]=useState(true);
...
const[projectInfoError,setProjectInfoError]=useState({})
  ...
  const uploadFormValidate = () => {
    console.log("logo", validImage)
    console.log("logo", validBanner)
    console.log("logo", validWebsite)
    console.log("logo", validDiscord)
    console.log("logo", validTwitter)
    ...
    if (validImage == true) {
      formIsValid = false;
      // errors["validImage"] = "Please upload Icon";
    ...
    if (validDiscord == false) {
      formIsValid = false;
    }

    if (validTwitter == false) {
      formIsValid = false;
    }
  ...
  const store = {
    ...
    validBanner:[validBanner, setvalidBanner],
    validImage:[validImage,setvalidImage],
    validWebsite:[validWebsite,setvalidwebsite],
    validDiscord:[validDiscord,setvalidIDiscord],
    validTwitter:[validTwitter,setvalidTwitter]
